...
export const docsData = {
  introduction: {
    title: "Welcome to Play2Love",
    content:
      " Play2Love is your ultimate destination for fun, rewards, and making a positive impact. Whether you're here to play games, earn rewards, or contribute to charitable causes, Play2Love has something for everyone. Dive in and explore the exciting opportunities that await you!",
  },
  "what-is-Play2Love": {
    title: "What Is Play2Love?",
    content:
      "Play2Love is a fab new place online where you can play fun, free games, via almost any device you choose. On top of that you can claim rewards for yourself and grab other benefits too. On Play2Love.com it's all about the work and the $$$ you earn this for yourself. On Play2Love.com you can donate your rewards and $$$ to major charities. On Play2Love.com you grab rewards and also get help with your healthy lifestyle. On Play2Love.com you are earning and learning. And on Play2Love.com grab your rewards while improving your lived environment. The more you play the more rewards you earn - it's super simple, fun and always free!",
  },
  "how-rewards-work": {
  ...
  "why-do-we-do-this": {
    ...
    content:
      "Given all that's going on in the world today we think it's important to give back and help others, especially those less fortunate. We also love fun, free casual games that we can play anytime on almost any device! So one day we decided to combine those two things and created Play2Love World. We are a small community of friendly folk who really believe in this initiative and are working passionately to make it a reality. We welcome all help and in fact you can see on our website different areas where more people can help support this in various ways. So if you feel the same jump in and play the games then contact us on social media to find out more!",
  },
};
